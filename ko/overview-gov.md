...
!!! tip "알아두기"
    ...
    * Cloud Access는 여러 가지 방식으로 구성할 수 있습니다. 자세한 설정 방법은 [콘솔 사용 가이드 - 시작하기](https://docs.gov-nhncloud.com/ko/Security/Cloud%20Access/ko/console-user-guide-gov/cloud-access-start-gov/)를 참고하세요.